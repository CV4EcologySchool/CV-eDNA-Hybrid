...
def main():
    ...
    parser.add_argument('--exp', help='Experiment name', default='exp_resnet18_37141_concat_noise')
    ...
    t3_acc = list(map(float, t3_acc))
    
    summary_stats = {"Accuracy": accuracy_values,
                     "Recall": recall,
                     "Top-3": t3_acc}
