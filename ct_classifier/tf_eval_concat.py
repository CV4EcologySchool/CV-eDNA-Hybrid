# -*- coding: utf-8 -*-
"""
Created on Mon Oct  2 19:50:12 2023
...
from tf_loader_concat import CTDataset   # Leave this, it helps for some reason
...
def main():
    ...
    parser.add_argument('--exp', help='Experiment name', default='exp_resnet18_37141_concat')
    ...
    named_pred_long, named_pred_short = hierarchy_pred(predicted_classes, hierarchy_long, hierarchy_short)
